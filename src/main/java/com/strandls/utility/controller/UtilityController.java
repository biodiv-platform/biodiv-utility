...
// CREATE
	...
	@Produces(MediaType.APPLICATION_JSON)
	@ValidateUser
	@Operation(summary = "Creates a new mini gallery", description = "Return created mini gallery", responses = {
			@ApiResponse(responseCode = "200", description = "Created", content = @Content(schema = @Schema(implementation = GalleryConfig.class))),
	...
	public Response createMiniGallery(@Context HttpServletRequest request,
			@RequestBody(description = "Mini gallery payload", required = true, content = @Content(schema = @Schema(implementation = GalleryConfig.class))) GalleryConfig miniGalleryData) {
		try {
...
// EDIT
	...
	@Produces(MediaType.APPLICATION_JSON)
	@ValidateUser
	@Operation(summary = "Edit mini gallery data", description = "Return updated mini gallery", responses = {
			@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = GalleryConfig.class))),
			@ApiResponse(responseCode = "400", description = "Unable to edit", content = @Content(schema = @Schema(implementation = String.class))),
			@ApiResponse(responseCode = "404", description = "Not found") })
	public Response editMiniGallery(@Context HttpServletRequest request,
			...
			@RequestBody(description = "Edit payload", required = true, content = @Content(schema = @Schema(implementation = GalleryConfig.class))) GalleryConfig editData) {
		try {
			if (galleryId == null) {
...
// DELETE
	...
	@Produces(MediaType.APPLICATION_JSON)
	@ValidateUser
	@Operation(summary = "Delete mini gallery data", description = "Deletes the mini gallery and returns no content", responses = {
			@ApiResponse(responseCode = "200", description = "Deleted"),
			@ApiResponse(responseCode = "400", description = "Unable to delete", content = @Content(schema = @Schema(implementation = String.class))),
			@ApiResponse(responseCode = "404", description = "Not found") })
...
// PUT: edit homepage mini gallery
	...
	@Produces(MediaType.APPLICATION_JSON)
	@ValidateUser
	@Operation(summary = "Edit homepage mini gallery data", description = "Return home page data")
	@ApiResponses({
			@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = HomePageData.class))),
			@ApiResponse(responseCode = "400", description = "Unable to retrieve the data", content = @Content(schema = @Schema(implementation = String.class))),
			@ApiResponse(responseCode = "404", description = "Not found") })
	public Response editMiniHomePage(@Context HttpServletRequest request,
			@Parameter(description = "Gallery ID") @PathParam("galleryId") String galleryId,
			@RequestBody(description = "Mini gallery slider edit payload", required = true, content = @Content(schema = @Schema(implementation = MiniGallerySlider.class))) MiniGallerySlider editData) {
		try {
			Long gId = Long.parseLong(galleryId);
...
// DELETE: delete homepage mini gallery
	...
	@Produces(MediaType.APPLICATION_JSON)
	@ValidateUser
	@Operation(summary = "Delete homepage mini gallery data", description = "Return home page data")
	@ApiResponses({
			@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = HomePageData.class))),
			@ApiResponse(responseCode = "400", description = "Unable to retrieve the data", content = @Content(schema = @Schema(implementation = String.class))),
			@ApiResponse(responseCode = "404", description = "Not found") })
	public Response removeMiniGallery(@Context HttpServletRequest request,
			@Parameter(description = "Gallery ID") @PathParam("galleryId") String galleryId) {
		try {
			Long gId = Long.parseLong(galleryId);
...
// PUT: reorder homepage gallery slider (List body)
	...
	@Produces(MediaType.APPLICATION_JSON)
	@ValidateUser
	@Operation(summary = "Reorder homepage gallery slider", requestBody = @RequestBody(required = true, description = "Array of reorder instructions", content = @Content(array = @ArraySchema(schema = @Schema(implementation = ReorderHomePage.class)))))
	@ApiResponses({
			@ApiResponse(responseCode = "200", description = "Home page data", content = @Content(schema = @Schema(implementation = HomePageData.class))),
...
// PUT: reorder mini homepage gallery slider (List body)
	...
	@Produces(MediaType.APPLICATION_JSON)
	@ValidateUser
	@Operation(summary = "Reorder mini homepage gallery slider", requestBody = @RequestBody(required = true, description = "Array of reorder instructions", content = @Content(array = @ArraySchema(schema = @Schema(implementation = ReorderHomePage.class)))))
	@ApiResponses({
			@ApiResponse(responseCode = "200", description = "Home page data", content = @Content(schema = @Schema(implementation = HomePageData.class))),
			@ApiResponse(responseCode = "404", description = "Not found", content = @Content(schema = @Schema(implementation = String.class))),
			@ApiResponse(responseCode = "400", description = "Unable to retrieve the data", content = @Content(schema = @Schema(implementation = String.class))) })
